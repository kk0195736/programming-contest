...
initial_balance = 1000000  # 初期資金の設定
...
for i in range(trials):  # trails回実行する
    ...
    while True:  # 取引を繰り返す
        ...
        while True:  # 勝つまで繰り返す
            ...
            if k <= 50:  # 勝ったのとき
                ...
                if max_losing_count < losing_streak_count:
                    max_losing_count = losing_streak_count
    ...
    print("result:{} win:{} 取引回数:{} 勝ち:{} 負け:{} 最大連敗数:{}".format(
        balance, balance - initial_balance, win_count + lose_count, win_count, lose_count, max_losing_count))  # 結果の出力
